		...
		for (int i = 0; i < 3; i++) {
			...
			for (int j = 0; j < 3; j++) {
				...
				for (int k = 0; k < 3; k++) {
					if (k == 0) {
						if (jLoop + n4 == target) {
							System.out.println(n1 + "" + (operators[i]) + "" + n2 + (operators[j]) + "" + n3
									+ (operators[k]) + "" + n4);
						}
					} else if (k == 1) {
						if (jLoop - n4 == target) {
		...
		for (int i = 0; i < 3; i++) {
			...
			for (int j = 0; j < 3; j++) {
				...
				for (int k = 0; k < 3; k++) {
					if (k == 0) {
						if (jLoop + n1 == target) {
							System.out.println(n4 + "" + (operators[i]) + "" + n3 + (operators[j]) + "" + n2
									+ (operators[k]) + "" + n1);
						}
					} else if (k == 1) {
						if (jLoop - n1 == target) {
		...
		for (int i = 0; i < 3; i++) {
			...
			for (int j = 0; j < 3; j++) {
				...
				for (int k = 0; k < 3; k++) {
					if (k == 0) {
						if (jLoop + n1 == target) {
							System.out.println(n4 + "" + (operators[i]) + "" + n2 + (operators[j]) + "" + n3
									+ (operators[k]) + "" + n1);
						}
					} else if (k == 1) {
						if (jLoop - n1 == target) {
		...
		for (int i = 0; i < 3; i++) {
			...
			for (int j = 0; j < 3; j++) {
				...
				for (int k = 0; k < 3; k++) {
					if (k == 0) {
						if (jLoop + n2 == target) {
							System.out.println(n1 + "" + (operators[i]) + "" + n4 + (operators[j]) + "" + n3
									+ (operators[k]) + "" + n2);
						}
					} else if (k == 1) {
						if (jLoop - n2 == target) {
